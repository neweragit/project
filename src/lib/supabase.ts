...
const EMAILJS_PUBLIC_KEY = 'EgAUjv4rnU3akQiFl';
const EMAILJS_SERVICE_ID = 'service_ys0ovse';
const EMAILJS_TEMPLATE_ID = 'template_0afhowp';
  ...
  async requestPasswordReset(email: string) {
    try {
      ...
      try {
        ...
        return { 
          data: { 
            message: 'Password reset code generated (check console for OTP)',
            otpCode: otpCode // Show OTP for development
          }, 
          error: null 
        };
      }
